...
export type MeResponse = {
  ...
  cloudSyncHighestMajorVersion?: Maybe<Scalars['String']['output']>;
...
export type DeleteTeamMutation = {
  __typename?: 'Mutation';
  deleteTeam: { __typename?: 'DeleteTeamResponse'; success: boolean };
};
...
export type InitializeTenantMutation = {
  __typename?: 'Mutation';
  initializeTenant: { __typename?: 'InitializationResponse'; success: boolean };
};

export type GetInitializationStatusQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetInitializationStatusQuery = {
  __typename?: 'Query';
...
export type GetTeamsWithMemberCountQueryVariables = Exact<{
  [key: string]: never;
}>;

export type GetTeamsWithMemberCountQuery = {
  __typename?: 'Query';
  getTeams: Array<{
    __typename?: 'Team';
    id: string;
...
export type RemoveTeamMemberByEmailMutation = {
  __typename?: 'Mutation';
  removeTeamMember: {
    __typename?: 'RemoveTeamMemberResponse';
    success: boolean;
...
export const UpdateTeamInfoDocument = {
  ...
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'UpdateTeamInfo' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
  ...
  UpdateTeamInfoMutationVariables
>;
...
} as unknown as DocumentNode<AddAdminMutation, AddAdminMutationVariables>;
...
export const InitializeTenantDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'InitializeTenant' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
  ...
  InitializeTenantMutation,
  InitializeTenantMutationVariables
>;
export const GetInitializationStatusDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                {
                  kind: 'Field',
                  name: { kind: 'Name', value: 'initializedAt' }
                }
              ]
            }
          }
  ...
  GetInitializationStatusQueryVariables
>;
        ...
        selections: [
          {
            ...
            selectionSet: {
              ...
              selections: [
                ...
                { kind: 'Field', name: { kind: 'Name', value: 'teamId' } },
                { kind: 'Field', name: { kind: 'Name', value: 'teamRole' } },
...
export const GetTeamsWithMemberCountDocument = {
  ...
  GetTeamsWithMemberCountQuery,
  GetTeamsWithMemberCountQueryVariables
>;
...
>;
export const RemoveTeamMemberByEmailDocument = {
  kind: 'Document',
  definitions: [
    {
      kind: 'OperationDefinition',
      operation: 'mutation',
      name: { kind: 'Name', value: 'RemoveTeamMemberByEmail' },
      variableDefinitions: [
        {
          kind: 'VariableDefinition',
          variable: {
  ...
  RemoveTeamMemberByEmailMutation,
  RemoveTeamMemberByEmailMutationVariables
>;
